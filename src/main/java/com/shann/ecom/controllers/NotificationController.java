...
public class NotificationController {
  ...
  @PostMapping("")
  public RegisterUserForNotificationResponseDto registerUser(
      @RequestBody RegisterUserForNotificationRequestDto requestDto) {
  ...
  @DeleteMapping("")
  public DeregisterUserForNotificationResponseDto deregisterUser(
      @RequestBody DeregisterUserForNotificationRequestDto requestDto) {
